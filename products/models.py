...
class Product(models.Model):
    ...
    number_of_selling   = models.IntegerField(default=0, null=True)
    price               = models.DecimalField(default=0.0, max_digits=15, decimal_places=3)
    create_at           = models.DateField()
    incategory          = models.ForeignKey(InCategory, on_delete=models.CASCADE)
